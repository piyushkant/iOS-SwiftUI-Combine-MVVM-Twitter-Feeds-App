...
struct HomeConfig {
    ...
    static let sampleSingleImageTweetId = "1370329824422551554" //1370325033663426560 //1370329824422551554
    ...
    var body: some View {
        ...
        NavigationView {
            ...
            .onAppear {
                ...
                homeViewModel.fetchSingleTimeLine(id: HomeConfig.sampleSingleImageTweetId)
            }
